...
export default function Cadastro() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Implementação futura: integração com Supabase para cadastro
    console.log('Cadastro com:', nome, email, senha, confirmarSenha, aceitaTermos)
  }
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
        ...
        <h2 className="text-3xl font-bold text-center mb-2">Acesse sua conta</h2>
        <p className="text-center text-gray-600 mb-8">Crie uma conta ou entre para continuar.</p>
        
        {/* Google Sign In Button */}
        <button 
          className="w-full flex justify-center items-center border border-gray-300 rounded-md py-3 px-4 mb-6 hover:bg-gray-50 transition"
        >
